...
then
	echo -e "\nPapirus is ${GREEN}${BOLD}already installed${CLEAR}. Skipping..."
else
...
then
	echo -e "\nCinnamenu is ${GREEN}${BOLD}already installed${CLEAR}. Skipping..."
else
...
then
	echo -e "\nWeather is ${GREEN}${BOLD}already installed${CLEAR}. Skipping..."
else
...
then
	echo -e "\nWatermark is ${GREEN}${BOLD}already installed${CLEAR}. Skipping..."
else
...
INSTALLED=$?
if [ $INSTALLED == '0' ]; then
	echo -e "\nZohoAssist is ${GREEN}${BOLD}already installed${CLEAR}. Skipping..."
else
...
echo ""
echo -e "${GREEN}${BOLD}Finished installing${CLEAR} software and extensions"
echo ""
